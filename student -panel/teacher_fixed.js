...
/* =====================================================
   3. GET TEACHER PROFILE (FIXED - REMOVED DUPLICATE)
===================================================== */
...
/* =====================================================
   4. GET CLASSES (TEACHER AS CLASS TEACHER)
===================================================== */
...
/* =====================================================
   5. GET SUBJECTS (TEACHER'S SUBJECTS)
===================================================== */
...
router.post('/attendance/mark', (req, res) => {
    ...
    // Get students of this teacher's class
...
/* =====================================================
   9. STUDENT-WISE ATTENDANCE SUMMARY
===================================================== */
...
/* =====================================================
   11. ADD MARKS (SUBJECT TEACHER ONLY)
===================================================== */
router.post('/marks/add', (req, res) => {
    ...
    pool.query(subjectSql, [subject_id, req.user.user_id], (err, subRows) => {
        ...
        // Get valid students for this subject's class
        const validStudentsSql = `
            SELECT student_id
            FROM students
            WHERE class_id = ?
        ...
        pool.query(
            ...
            (err, studentRows) => {
                ...
                const values = filteredMarks.map(m => {
                    const grade = calculateGrade(m.marks_obtained, max_marks)
                    return [
                        m.student_id,
                        subject_id,
                        exam_name,
...
/* =====================================================
   14. CLASS PERFORMANCE (CLASS TEACHER)
===================================================== */
router.get('/class/performance', (req, res) => {
    if (!teacherOnly(req, res)) return

    // Ensure this teacher is a class teacher
    const classCheckSql = `
        SELECT class_id
        FROM classes c
        JOIN employees e ON c.class_teacher_id = e.employee_id
...
/* =====================================================
   15. TOP 3 STUDENTS (CLASS)
===================================================== */
router.get('/class/top-students', (req, res) => {
    if (!teacherOnly(req, res)) return

    // Ensure teacher is class teacher
    const classCheckSql = `
        SELECT class_id
        FROM classes c
        JOIN employees e ON c.class_teacher_id = e.employee_id
